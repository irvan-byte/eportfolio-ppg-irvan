...
export default function PortfolioPage() {
  ...
  const handleOpenItem = (item: PortfolioItem) => toast.info(`Dokumen ${item.judul} belum ditautkan`, { description: "Data file dapat ditambahkan di client/src/data/portfolioData.ts." });
  return (
