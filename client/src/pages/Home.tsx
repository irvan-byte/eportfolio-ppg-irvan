            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 xl:col-span-7 relative">
                <div className="relative min-h-[430px] rounded-[2rem] overflow-hidden shadow-2xl shadow-slate-300/70 border border-white">
                  <img src="../client/src/assets/home.webp" alt="Meja belajar dengan perangkat Informatika dan catatan refleksi" className="absolute inset-0 w-full h-full object-cover" />
